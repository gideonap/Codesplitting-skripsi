        ...
        <div>
            ...
            <div className='flex flex-col gap-16'>
                <div
                    ...
                    <div ref={sec1Ref}
                         className={`relative flex flex-col items-center lg:items-start justify-center lg: gap-5 w-72 lg:w-fit text-white h-full z-10 transition-opacity duration-1000 ${sec1InView ? 'opacity-100' : 'opacity-0'}`}>
                ...
                <div className='flex flex-col gap-24'>
                    ...
                    <div ref={sec4Ref}
                         className={`flex flex-col gap-8 items-center transition-opacity duration-1000 ${sec4InView ? 'opacity-100' : 'opacity-0'}`}>
                        <div className='flex flex-col gap-2 items-center text-center'>
                    ...
                    <div
                        ...
                        <div className='absolute inset-0 bg-black opacity-60'></div>
                        <div ref={sec5Ref}
                             className={`relative flex flex-col lg:flex-row lg:justify-between gap-7 lg:gap-0 items-center lg:items-center w-full px-14 lg:px-28 transition-opacity duration-1000 ${sec5InView ? 'opacity-100' : 'opacity-0'}`}>
                    ...
                    <div ref={sec6Ref}
                         className={`flex flex-col gap-8 items-center transition-opacity duration-1000 ${sec6InView ? 'opacity-100' : 'opacity-0'}`}>
                        <div className='flex flex-col gap-2 items-center text-center'>
                            <p className='text-lg text-secondary-gray'>Temukan kehangatan di Bedengan</p>
