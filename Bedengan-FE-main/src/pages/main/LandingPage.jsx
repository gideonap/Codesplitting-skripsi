...
const handleButtonClick = () => {
  toast(
    'Pemesanan dengan metode "Paket" belum tersedia. Silahkan reservasi dengan metode normal'
  );
};
  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-16">
        <div className="relative flex flex-col bg-[url('/images/background.JPG')] bg-cover bg-center h-screen w-screen lg:w-auto px-10 lg:pl-28 lg:pr-[25rem]">
          ...
          >
            ...
            <p className="text-primary text-sm lg:text-lg">
              Temukan kedamaian dan keindahan alam di jantung Bedengan dengan
              <br /> pengalaman berkemah yang tak terlupakan.
            </p>
            <Button
              onClick={() => {
        ...
        <div className="flex flex-col gap-24">
          ...
          >
            <div className="flex flex-col gap-2 items-center text-center">
              <p className="text-lg text-secondary-gray">
                Temukan kehangatan di Bedengan
              </p>
            ...
            <div className="flex flex-col gap-8 lg:flex-row px-10 lg:px-28 lg:gap-10 items-center">
              ...
              <div className="flex flex-col gap-9  items-center lg:items-start">
                <p>
                  Temukan kedamaian dan keindahan alam di jantung Bedengan
                  dengan pengalaman berkemah yang tak terlupakan. Pilih dari
                  berbagai lokasi perkemahan yang mempesona. nikmati fasilitas
                  modern, dan rasakan ketenangan jauh dari hiruk-pikuk kota.
                  Mulai petualangan Anda hari ini dengan mudah - cari tanggal,
                  pilih lokasi, dan buat reservasi hanya dengan beberapa klik!
                </p>
                <Button
                  onClick={() => {
                    handleNavigateToLink("/reservasi");
          ...
          >
            <div className="flex flex-col gap-2 items-center text-center">
              <p className="text-lg text-secondary-gray">
                Pahami dan simak syarat dan ketentuan sebelum reservasi
              </p>
            ...
            <div className="flex flex-col gap-8 lg:flex-row px-10 lg:px-28 lg:gap-10 items-center">
              <div className="flex flex-col gap-9  items-center lg:items-start">
                <p>
                  Sudah tidak sabar untuk menikmati keindahan alam di jantung
                  Bedengan? Eitss, cek syarat dan ketentuan sebelum melakukan
                  reservasi. Pastikan kamu memahami dan menyetujui syarat dan
                  ketentuan yang berlaku. Cek sekarang, lakukan reservasi, dan
                  sampai berjumpa di mana kamu dapat menemukan ketenangan!
                </p>
                <Button
                  onClick={() => {
          ...
          >
            <div className="flex flex-col gap-2 items-center text-center">
              <p className="text-lg text-secondary-gray">
                Jangan khawatir kekurangan apapun
              </p>
          ...
          >
            <div className="flex flex-col gap-2 items-center text-center">
              <p className="text-lg text-secondary-gray">
                Tentukan pilihanmu sesuai dengan kebutuhanmu
              </p>
          ...
          <div className="relative flex bg-[url('/images/background.JPG')] bg-cover bg-center min-h-[50vh] w-screen lg:w-auto place-content-center items-center">
            <div className="absolute inset-0 bg-black opacity-60"></div>
            <div
            ...
            >
              <h1 className="text-lg lg:text-3xl text-white font-semibold w-56 max-w-full lg:w-[35rem] lg:max-w-[35rem]">
                Sudah siap menikmati keindahan hutan pinus?
              </h1>
              <Button
                onClick={() => {
                  handleNavigateToLink("/reservasi");
                ...
                <div className="flex flex-col gap-3 justify-start lg:pr-20">
                  ...
                  <div className="flex flex-row items-center gap-5">
                    ...
                    <p className="text-secondary">
                      Jl. Raya Selokarto, Selorejo, Kec. Dau,
                      <br />
          ...
          >
            <div className="flex flex-col gap-2 items-center text-center">
              <p className="text-lg text-secondary-gray">
                Lihat dan Tentukan Spot Campingan!
              </p>
              <h2 className="font-semibold">Peta Bumi Perkemahan Bedengan</h2>
            </div>
            <div className="flex flex-col gap-8 lg:flex-row px-10 lg:px-28 lg:gap-10 items-center">
              <img
                src="/images/PetaBedengan.jpeg"
                alt=""
